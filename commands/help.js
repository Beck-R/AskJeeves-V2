...
const { bot_age, prefix, name, version, blacklist } = require("../config.json");
...
module.exports = {
  ...
  execute(message, args) {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        `${name}`,
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVfHPucqTDHcfg-8H6KK3ErTp5jobfEPyu0C5Fc87hqW1I3WGFO08O1d-cboLHWtPde-Y&usqp=CAU"
      )
      .setTitle("Help Desk:")
      .setDescription(
      ...
      .addFields(
        ...
        {
          name: "Clear Usage:",
          value: `\`${prefix} clear <# of messages>\``,
          inline: true,
        },
        {
          name: "Add-role Usage:",
          value: `\`${prefix} add-role <@user> <role>\``,
          inline: true,
        },
        {
          name: "Remove-role Usage:",
          value: `\`${prefix} remove-role <@user> <role>\``,
          inline: true,
        },
        { name: "\u200b", value: "\u200b" },
        ...
        {
          name: "Kayne-quote Usage:",
          value: `\`${prefix} kanye-quote <sfw/nsfw> <category>\``,
          inline: true,
        },
        { name: "\u200b", value: "\u200b" },
    ...
    if (!args.length) {
      ...
      help_embed
        .setTitle("Clear Usage:")
        .setDescription(`\`clears specified amount of messages\``)
        .addFields({ name: "Example:", value: `\`${prefix} clear 10\`` });
      message.channel.send(help_embed);
    } else if (args[0] == "add-role") {
      help_embed
        .setTitle("Add-role Usage:")
      ...
      help_embed
        ...
        .addFields({
          name: "Example:",
          value: `\`${prefix} kanye-quote sfw neko\``,
        });
      message.channel.send(help_embed);
    } else {
